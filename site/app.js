...
app.get('/register',(req,res) => res.sendFile(path.resolve(__dirname,'views','detalle.html')))
app.get('/register',(req,res) => res.sendFile(path.resolve(__dirname,'views','carrito.html')))
